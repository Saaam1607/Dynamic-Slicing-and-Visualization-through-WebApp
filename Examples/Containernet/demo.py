...
server = net.addDocker('server', ip='10.0.0.251', dcmd="python app.py", dimage="test_server:latest")    # container server che appena runna esegue comando 'python app.py'
                                                                                                        # come immagine runna l'immagine 'test_server:latest'
client = net.addDocker('client', ip='10.0.0.252', dimage="test_client:latest")                          # container client che runna l'immagine 'test_client:latest'
